...
JNIEXPORT void
JNICALL Java_gq_netin_drill_hasher_Hasher_slowHash(JNIEnv *env, jclass clazz, jbyteArray input, jbyteArray output, jint variant) {
	...
	cn_slow_hash(inputBuffer, inputSize, outputBuffer, (int)variant, NULL);
